...
const SearchBar = ({ colorScheme, setUser, getData, user }) => {
  return (
    <View className="flex-row items-center justify-between px-4 py-2 mt-3 bg-white shadow-xl dark:bg-lightBlue shadow-black rounded-xl ">
      <View className="flex-row items-center">
        <AntDesign className="mt-1 " name="search1" size={20} color="#0079ff" />
        <TextInput
          onChangeText={setUser}
          className="h-10 pr-3 ml-3 dark:text-light w-60"
